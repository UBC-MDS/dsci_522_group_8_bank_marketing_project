...
To replicate this analysis: 1. Clone this repository (`git clone https://github.com/UBC-MDS/dsci_522_group_8_bank_marketing_project`) 2. Install all required dependencies and activate the project virtual environemnt 3. Access datasets, scripts, and reports by running `make all` in the CLI from the root directory of this project.
